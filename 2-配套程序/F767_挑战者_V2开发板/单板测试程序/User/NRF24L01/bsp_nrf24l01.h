...
#define NRF1_CE_GPIO_PORT               GPIOG                 
#define NRF1_CE_GPIO_CLK_ENABLE()        __GPIOG_CLK_ENABLE()

/*CSN引脚*/
#define NRF1_CSN_PIN                     GPIO_PIN_10                 
#define NRF1_CSN_GPIO_PORT               GPIOG                      
#define NRF1_CSN_GPIO_CLK_ENABLE()       __GPIOG_CLK_ENABLE()

/*SCK引脚*/
#define NRF1_CLK_PIN                      GPIO_PIN_13              
#define NRF1_CLK_GPIO_PORT                GPIOB                       
#define NRF1_CLK_GPIO_CLK_ENABLE()      __GPIOB_CLK_ENABLE()

/*MISO引脚*/
#define NRF1_MISO_PIN                     GPIO_PIN_14                
#define NRF1_MISO_GPIO_PORT               GPIOB                       
#define NRF1_MISO_GPIO_CLK_ENABLE()      __GPIOB_CLK_ENABLE()


/*MOSI引脚*/
#define NRF1_MOSI_PIN                    GPIO_PIN_15                
#define NRF1_MOSI_GPIO_PORT              GPIOB                       
#define NRF1_MOSI_GPIO_CLK_ENABLE()      __GPIOB_CLK_ENABLE()
...
/*CSN引脚*/
#define NRF2_CSN_PIN                     GPIO_PIN_3                 
#define NRF2_CSN_GPIO_PORT               GPIOI                      
#define NRF2_CSN_GPIO_CLK_ENABLE()       __GPIOI_CLK_ENABLE()
