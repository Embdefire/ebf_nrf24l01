...
#define NRF_SPI_SCK_GPIO_PORT             GPIOA                       
#define NRF_SPI_SCK_GPIO_CLK              RCC_AHB1Periph_GPIOA
#define NRF_SPI_SCK_PINSOURCE             GPIO_PinSource5
#define NRF_SPI_SCK_AF                    GPIO_AF_SPI1

#define NRF_SPI_MISO_PIN                  GPIO_Pin_6                
#define NRF_SPI_MISO_GPIO_PORT            GPIOA                   
#define NRF_SPI_MISO_GPIO_CLK             RCC_AHB1Periph_GPIOA
#define NRF_SPI_MISO_PINSOURCE            GPIO_PinSource6
#define NRF_SPI_MISO_AF                   GPIO_AF_SPI1

#define NRF_SPI_MOSI_PIN                  GPIO_Pin_7               
#define NRF_SPI_MOSI_GPIO_PORT            GPIOA                     
#define NRF_SPI_MOSI_GPIO_CLK             RCC_AHB1Periph_GPIOA
#define NRF_SPI_MOSI_PINSOURCE            GPIO_PinSource7
...
#define NRF_IRQ_GPIO_CLK     RCC_AHB1Periph_GPIOA
