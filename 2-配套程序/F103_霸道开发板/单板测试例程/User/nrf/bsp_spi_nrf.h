...
#define NRF_CSN_GPIO_CLK     RCC_APB2Periph_GPIOG

#define NRF_CE_GPIO_PORT    GPIOG
#define NRF_CE_PIN          GPIO_Pin_8
#define NRF_CE_GPIO_CLK     RCC_APB2Periph_GPIOG
...
#define NRF2_IRQ_PIN          GPIO_Pin_4
#define NRF2_IRQ_GPIO_CLK     RCC_APB2Periph_GPIOA
