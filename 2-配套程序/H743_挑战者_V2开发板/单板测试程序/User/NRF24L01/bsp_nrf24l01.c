...
void SPI_NRF1_Init(void)
{
    ...
    NRF1_Handler.Init.MasterKeepIOState=SPI_MASTER_KEEP_IO_STATE_ENABLE;  //SPI主模式IO状态保持使能
		NRF1_Handler.Init.TIMode=SPI_TIMODE_DISABLE;     //关闭TI模式
    NRF1_Handler.Init.CRCCalculation=SPI_CRCCALCULATION_DISABLE;//关闭硬件CRC校验
...
void SPI_NRF2_Init(void)
{
    ...
    NRF2_Handler.Init.MasterKeepIOState=SPI_MASTER_KEEP_IO_STATE_ENABLE;  //SPI主模式IO状态保持使能
		NRF2_Handler.Init.TIMode=SPI_TIMODE_DISABLE;     //关闭TI模式
    NRF2_Handler.Init.CRCCalculation=SPI_CRCCALCULATION_DISABLE;//关闭硬件CRC校验
